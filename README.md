...
### Railway Docker
[![Deploy on Railway](https://railway.app/button.svg)](https://railway.app/new/template/dockerfile?template=https://https://github.com/IamElite/YAPI01)
...
### 3. Clone & Setup
```bash
git clone https://https://github.com/IamElite/YAPI01.git
...
### Audio Download
```bash
curl "https://your-domain.com/query?key=API_KEY&query=song+name&video=false"
```

### Video Download
```bash
curl "https://your-domain.com/query?key=API_KEY&query=video+name&video=true"
```
